# Educations
## 42Tokyo | 2025/4~
- Fundamentals of computer science learned through hands-on development
...
- Experience in code review and team development
...
- Self-reliance in environments without instructors
...
- 実践的な開発を通じたコンピュータサイエンスの基礎習得
シェルやWebサーバーを一から開発し、直接システムコールを呼び出すなどの実践を通じて、コンピュータのリソース管理、データ構造、アルゴリズムについて学びました。
- コードレビューおよびチーム開発の経験
ピアレビューやチーム開発プロジェクトを通じて、ソースコードの可読性や明確なソフトウェア設計を重視しながら、ソフトウェア開発の上流から下流までの基礎スキルを習得しました。また、GitとGitHubを用いたチーム開発に不可欠なスキルも身につけました。
- 講師のいない環境での自律的な学習
仕様書のみが与えられる環境で開発を始めることで、調査、要件定義、設計、実装、テスト、スケジュール管理をすべて自律的に行う経験を積みました。